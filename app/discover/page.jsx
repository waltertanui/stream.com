...
function discover() {
  return (
    <div className='bg-black'>
        ...
        <div className='flex h-40 gap-4 mt-10 justify-center mx-48'>
          <img class="w-full sm:w-1/2 lg:w-1/4" src="/assets/discover1.jpeg" alt="description"/>
          <img className='w-full sm:w-1/2 lg:w-1/4' src='/assets/discover2.jpeg' alt='description'/>
          <img className='w-full sm:w-1/2 lg:w-1/4' src='/assets/discover3.jpeg' alt='description'/>
          <img className='w-full sm:w-1/2 lg:w-1/4' src='/assets/discover4.jpeg' alt='description'/>
        </div>
  ...
  <div class="w-full md:w-1/2 text-white">
    <h3 class="hidden md:block">Explore Stream</h3>
    <h1 class="desc hidden md:block">Discover endless possibilities</h1>
    <p class="text-gray-300 md:mr-28 hidden md:block">
  ...
  <div class="w-full md:w-1/2 mt-6 md:mt-0 relative">
    ...
    />
    <div class="absolute inset-0 flex items-center justify-center text-white text-center p-8 md:hidden">
      <div>
  ...
  <div className="w-full md:w-1/2 absolute inset-0 flex flex-col justify-center items-center text-white md:relative">
    ...
    <div className='text-white text-center'>
      ...
      {/*section 5 */}
      <div class="flex flex-col md:flex-row mb-20 px-4 mt-20 relative">
  ...
  <div class="w-full md:w-1/2 absolute inset-0 flex flex-col justify-center items-center text-white md:relative ml-10">
    <div class="text-center">
      <h3 class="mt-6">Explore Stream</h3>
      <h1 class="desc">Our Platform</h1>
      <p class="text-gray-300 md:mr-28">
  ...
  <div className='md:ml-10 w-full md:w-1/2 absolute inset-0 md:relative'>
    <h3 className='text-white mb-5 text-center md:text-left'>Explore Stream</h3>
    <h1 className='text-3xl text-white mb-5 text-center md:text-left'>Our Values</h1>
